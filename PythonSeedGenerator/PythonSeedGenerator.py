...
for mode in modeDict.keys():
    ...
    for seed in range(0,1):
        ...
        #will need to change output
        output = open("seed_" + mode + "_randomizer_" + mode + "_" + str(seed) + ".dat", 'w')
        
        #will need to change spoiler output
        spoiler = open("spoilers_" + mode + "_spoiler_" + mode + "_" + str(seed) + ".txt", 'w')
